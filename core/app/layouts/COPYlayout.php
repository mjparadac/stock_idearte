    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>INVENTARIO</b>IDEARTE</span>
        </a>
...
<div class="user-panel">
    ...
    <?php endif;?>
      ...
      <div class="content">
        ...
        <strong>Copyright &copy; 2021 <a href="https://www.instagram.com/ide_arte/" target="_blank">IDEARTE</a></strong>
      </footer>
      <?php else:?>
<div class="login-box">
      <div class="login-logo">
        <a href="./">INVENTARIO<b>IDEARTE</b></a>
      </div><!-- /.login-logo -->
